...
const FeaturesSectionDemo2: React.FC<FeaturesSectionDemoProps> = ({
  grid,
  ...
  return (
    ...
    <div className="grid dark:bg-slate-950 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 md:gap-5 max-w-[1800px] px-5 mx-auto">
      {grid.map((feature) => (
        <div
          key={feature._id}
...
>Faild</span>
            ...
            <button
              ...
              className="mt-6 ml-3 z-[1] shadow-[0_4px_14px_0_rgb(0,0,0,10%)] hover:shadow-[0_6px_20px_rgba(93,93,93,23%)] px-6 py-2 bg-[#fff] text-[#696969] rounded-md font-light transition duration-200 ease-linear"
            >
                 <TbHttpDelete/>
            </button>
          </div>
...
export default FeaturesSectionDemo2;
